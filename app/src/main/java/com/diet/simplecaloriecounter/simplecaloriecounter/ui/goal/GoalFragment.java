...
public class GoalFragment extends Fragment implements IOnBackPressed {
   ...
   public void initializeGetDataFromDbAndDisplay(){
       ...
       if(goalIWantTo.equals("0")){
           method = "Giảm"  + goalWeeklyGoal;
       }
       else{
           method = "Tăng"  + goalWeeklyGoal;
       }
       if(mesurment.startsWith("m")) {
           method = method + " kg/Tuần";
       }
       else{
           method = method + " pounds/Tuần";
       }
       ...
       if(goalActivityLevel.equals("0")){
           textViewActivityLevel.setText("Ít hoặc không tập thể dục");
       }
       else if(goalActivityLevel.equals("1")){
           textViewActivityLevel.setText("Tập thể dục nhẹ (1–3 ngày trong tuần)");
       }
       else if(goalActivityLevel.equals("2")){
           textViewActivityLevel.setText("Tập thể dục vừa (3–5 ngày trong tuần)");
       }
       else if(goalActivityLevel.equals("3")){
           textViewActivityLevel.setText("Tập thể dục nặng (6–7 ngày trong tuần)");
       }
       else if(goalActivityLevel.equals("4")){
           textViewActivityLevel.setText("Tập thể dục siêu nặng (2 lần/ngày,các bài tập nặng)");
       }
