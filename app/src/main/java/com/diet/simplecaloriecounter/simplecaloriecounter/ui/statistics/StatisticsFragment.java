...
public class StatisticsFragment extends Fragment implements IOnBackPressed {
    ...
    private void InitializeBarChart(String currentDate){
        ...
        LimitLine ll = new LimitLine(Float.parseFloat(goalActivityAndDiet), "Mục tiêu với hoạt động và chế độ ăn uống");
        ...
        LimitLine ll1 = new LimitLine(Float.parseFloat(goalDiet), "Mục tiêu với chế độ ăn kiêng");
        ...
        LimitLine ll2 = new LimitLine(Float.parseFloat(goalActivity), "Mục tiêu chỉ hoạt động");
        ...
        LimitLine ll3 = new LimitLine(Float.parseFloat(goalBMR), "Mục tiêu cơ bản ở mức nghỉ ngơi/tỷ lệ trao đổi chất ");
